...
func (f *Framework) CreateReclaimSpaceJob(name string, pvcName string) *csiaddonsv1alpha1.ReclaimSpaceJob {
	By(fmt.Sprintf("Creating ReclaimSpaceJob %s for PVC %s", name, pvcName))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create ReclaimSpaceJob")
...
func (f *Framework) WaitForReclaimSpaceJobComplete(name string) *csiaddonsv1alpha1.ReclaimSpaceJob {
	By(fmt.Sprintf("Waiting for ReclaimSpaceJob %s to complete", name))
	...
	Expect(err).NotTo(HaveOccurred(), "ReclaimSpaceJob did not complete in time")
	return rsJob
}
...
func (f *Framework) GetReclaimSpaceJob(name string) *csiaddonsv1alpha1.ReclaimSpaceJob {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get ReclaimSpaceJob")
	return rsJob
}
...
func (f *Framework) CreateReclaimSpaceCronJob(name string, pvcName string, schedule string) *csiaddonsv1alpha1.ReclaimSpaceCronJob {
	By(fmt.Sprintf("Creating ReclaimSpaceCronJob %s for PVC %s with schedule %s", name, pvcName, schedule))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create ReclaimSpaceCronJob")
...
func (f *Framework) GetReclaimSpaceCronJob(name string) *csiaddonsv1alpha1.ReclaimSpaceCronJob {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get ReclaimSpaceCronJob")
	return rsCronJob
}
...
func (f *Framework) ListReclaimSpaceJobs(labelSelector map[string]string) *csiaddonsv1alpha1.ReclaimSpaceJobList {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to list ReclaimSpaceJobs")
	return jobList
}

// WaitForReclaimSpaceJobCreation waits for at least one ReclaimSpaceJob to be created
func (f *Framework) WaitForReclaimSpaceJobCreation(labelSelector map[string]string, timeout time.Duration) *csiaddonsv1alpha1.ReclaimSpaceJob {
	By("Waiting for ReclaimSpaceJob to be created by CronJob")
	...
	err := wait.PollUntilContextTimeout(ctx, 2*time.Second, timeout, true, func(ctx context.Context) (bool, error) {
		jobList := f.ListReclaimSpaceJobs(labelSelector)
	...
	Expect(err).NotTo(HaveOccurred(), "No ReclaimSpaceJob was created in time")
	return createdJob
}
...
func (f *Framework) CreateEncryptionKeyRotationJob(name string, pvcName string) *csiaddonsv1alpha1.EncryptionKeyRotationJob {
	By(fmt.Sprintf("Creating EncryptionKeyRotationJob %s for PVC %s", name, pvcName))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create EncryptionKeyRotationJob")
...
func (f *Framework) WaitForEncryptionKeyRotationJobComplete(name string) *csiaddonsv1alpha1.EncryptionKeyRotationJob {
	By(fmt.Sprintf("Waiting for EncryptionKeyRotationJob %s to complete", name))
	...
	Expect(err).NotTo(HaveOccurred(), "EncryptionKeyRotationJob did not complete in time")
	return ekrJob
}
...
func (f *Framework) CreateEncryptionKeyRotationCronJob(name string, pvcName string, schedule string) *csiaddonsv1alpha1.EncryptionKeyRotationCronJob {
	By(fmt.Sprintf("Creating EncryptionKeyRotationCronJob %s for PVC %s with schedule %s", name, pvcName, schedule))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create EncryptionKeyRotationCronJob")
...
func (f *Framework) GetEncryptionKeyRotationCronJob(name string) *csiaddonsv1alpha1.EncryptionKeyRotationCronJob {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get EncryptionKeyRotationCronJob")
	return ekrCronJob
}
...
func (f *Framework) ListEncryptionKeyRotationJobs(labelSelector map[string]string) *csiaddonsv1alpha1.EncryptionKeyRotationJobList {
	...
	err := f.Client.List(ctx, jobList, listOpts...)
	Expect(err).NotTo(HaveOccurred(), "Failed to list EncryptionKeyRotationJobs")
	return jobList
}

// WaitForEncryptionKeyRotationJobCreation waits for at least one EncryptionKeyRotationJob to be created
func (f *Framework) WaitForEncryptionKeyRotationJobCreation(labelSelector map[string]string, timeout time.Duration) *csiaddonsv1alpha1.EncryptionKeyRotationJob {
	By("Waiting for EncryptionKeyRotationJob to be created by CronJob")
	...
	err := wait.PollUntilContextTimeout(ctx, 2*time.Second, timeout, true, func(ctx context.Context) (bool, error) {
		jobList := f.ListEncryptionKeyRotationJobs(labelSelector)
		if len(jobList.Items) > 0 {
			createdJob = &jobList.Items[0]
			return true, nil
		}
	...
	Expect(err).NotTo(HaveOccurred(), "No EncryptionKeyRotationJob was created in time")
	return createdJob
}
...
func (f *Framework) CreateNetworkFence(name string, cidrs []string, fenceState csiaddonsv1alpha1.FenceState) *csiaddonsv1alpha1.NetworkFence {
	By(fmt.Sprintf("Creating NetworkFence %s", name))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create NetworkFence")
...
func (f *Framework) GetNetworkFence(name string) *csiaddonsv1alpha1.NetworkFence {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get NetworkFence")
	return nf
}
...
func (f *Framework) CreateNetworkFenceWithClass(name string, cidrs []string, fenceState csiaddonsv1alpha1.FenceState, className string) *csiaddonsv1alpha1.NetworkFence {
	By(fmt.Sprintf("Creating NetworkFence %s with NetworkFenceClass %s", name, className))
	...
	err := f.Client.Create(ctx, nf)
	Expect(err).NotTo(HaveOccurred(), "Failed to create NetworkFence with class")
...
func (f *Framework) UpdateNetworkFence(nf *csiaddonsv1alpha1.NetworkFence) *csiaddonsv1alpha1.NetworkFence {
	By(fmt.Sprintf("Updating NetworkFence %s", nf.Name))

	ctx, cancel := context.WithTimeout(context.Background(), f.GetTimeout("operation"))
	defer cancel()

	err := f.Client.Update(ctx, nf)
	Expect(err).NotTo(HaveOccurred(), "Failed to update NetworkFence")
	return nf
}
...
func (f *Framework) WaitForNetworkFenceResult(name string, expectedResult csiaddonsv1alpha1.FencingOperationResult) *csiaddonsv1alpha1.NetworkFence {
	By(fmt.Sprintf("Waiting for NetworkFence %s to have result %s", name, expectedResult))
	...
	Expect(err).NotTo(HaveOccurred(), fmt.Sprintf("NetworkFence did not reach result %s in time", expectedResult))
	return nf
}
...
func (f *Framework) CreateNetworkFenceClass(name string, provisioner string, parameters map[string]string) *csiaddonsv1alpha1.NetworkFenceClass {
	By(fmt.Sprintf("Creating NetworkFenceClass %s", name))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create NetworkFenceClass")
...
func (f *Framework) GetNetworkFenceClass(name string) *csiaddonsv1alpha1.NetworkFenceClass {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get NetworkFenceClass")
	return nfc
}
...
func (f *Framework) CreateVolumeReplicationClass(name string, provisioner string, parameters map[string]string) *replicationv1alpha1.VolumeReplicationClass {
	By(fmt.Sprintf("Creating VolumeReplicationClass %s", name))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create VolumeReplicationClass")
...
func (f *Framework) CreateVolumeReplication(name string, pvcName string, vrcName string, replicationState replicationv1alpha1.ReplicationState) *replicationv1alpha1.VolumeReplication {
	By(fmt.Sprintf("Creating VolumeReplication %s for PVC %s", name, pvcName))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create VolumeReplication")
...
func (f *Framework) WaitForVolumeReplicationState(name string, expectedState replicationv1alpha1.State) *replicationv1alpha1.VolumeReplication {
	By(fmt.Sprintf("Waiting for VolumeReplication %s to reach state %s", name, expectedState))
	...
	Expect(err).NotTo(HaveOccurred(), fmt.Sprintf("VolumeReplication did not reach state %s in time", expectedState))
	return vr
}
...
func (f *Framework) GetVolumeReplication(name string) *replicationv1alpha1.VolumeReplication {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get VolumeReplication")
	return vr
}
...
func (f *Framework) UpdateVolumeReplication(vr *replicationv1alpha1.VolumeReplication) {
	By(fmt.Sprintf("Updating VolumeReplication %s", vr.Name))

	ctx, cancel := context.WithTimeout(context.Background(), f.GetTimeout("operation"))
	defer cancel()

	err := f.Client.Update(ctx, vr)
	Expect(err).NotTo(HaveOccurred(), "Failed to update VolumeReplication")
}

// DeleteResource deletes a resource
func (f *Framework) DeleteResource(obj client.Object) {
	By(fmt.Sprintf("Deleting resource %s/%s", obj.GetObjectKind().GroupVersionKind().Kind, obj.GetName()))
	...
	if err != nil && !apierrors.IsNotFound(err) {
		Expect(err).NotTo(HaveOccurred(), "Failed to delete resource")
	}
}
...
func (f *Framework) WaitForResourceDeleted(obj client.Object, timeout time.Duration) {
	By(fmt.Sprintf("Waiting for resource %s/%s to be deleted", obj.GetObjectKind().GroupVersionKind().Kind, obj.GetName()))
	...
	Expect(err).NotTo(HaveOccurred(), "Resource was not deleted in time")
}
...
func (f *Framework) CreateVolumeGroupReplicationClass(name string, provisioner string, parameters map[string]string) *replicationv1alpha1.VolumeGroupReplicationClass {
	By(fmt.Sprintf("Creating VolumeGroupReplicationClass %s", name))
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to create VolumeGroupReplicationClass")
...
func (f *Framework) GetVolumeGroupReplicationClass(name string) *replicationv1alpha1.VolumeGroupReplicationClass {
	...
	Expect(err).NotTo(HaveOccurred(), "Failed to get VolumeGroupReplicationClass")
	return vgrc
}
