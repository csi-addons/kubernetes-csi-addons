...
func (c *reclaimSpaceClient) ControllerReclaimSpace(ctx context.Context, in *ReclaimSpaceRequest, opts ...grpc.CallOption) (*ReclaimSpaceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ReclaimSpace/ControllerReclaimSpace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reclaimSpaceClient) NodeReclaimSpace(ctx context.Context, in *ReclaimSpaceRequest, opts ...grpc.CallOption) (*ReclaimSpaceResponse, error) {
	out := new(ReclaimSpaceResponse)
	err := c.cc.Invoke(ctx, "/proto.ReclaimSpace/NodeReclaimSpace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReclaimSpace_ControllerReclaimSpace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ReclaimSpace/ControllerReclaimSpace",
	}
...
func _ReclaimSpace_NodeReclaimSpace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ReclaimSpace/NodeReclaimSpace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
