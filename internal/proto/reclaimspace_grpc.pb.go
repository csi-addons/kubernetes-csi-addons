...
func (c *reclaimSpaceClient) ControllerReclaimSpace(ctx context.Context, in *ReclaimSpaceRequest, opts ...grpc.CallOption) (*ReclaimSpaceResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReclaimSpace_ControllerReclaimSpace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reclaimSpaceClient) NodeReclaimSpace(ctx context.Context, in *ReclaimSpaceRequest, opts ...grpc.CallOption) (*ReclaimSpaceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReclaimSpaceResponse)
	err := c.cc.Invoke(ctx, ReclaimSpace_NodeReclaimSpace_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedReclaimSpaceServer must be embedded to have
...
func (UnimplementedReclaimSpaceServer) ControllerReclaimSpace(context.Context, *ReclaimSpaceRequest) (*ReclaimSpaceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ControllerReclaimSpace not implemented")
}
func (UnimplementedReclaimSpaceServer) NodeReclaimSpace(context.Context, *ReclaimSpaceRequest) (*ReclaimSpaceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NodeReclaimSpace not implemented")
}
func (UnimplementedReclaimSpaceServer) mustEmbedUnimplementedReclaimSpaceServer() {}
func (UnimplementedReclaimSpaceServer) testEmbeddedByValue()                      {}
...
func RegisterReclaimSpaceServer(s grpc.ServiceRegistrar, srv ReclaimSpaceServer) {
	// If the following call panics, it indicates UnimplementedReclaimSpaceServer was
